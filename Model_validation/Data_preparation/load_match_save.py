...
def for_vd(path_subjects_edf, subject_edf, meas_time_df, path_save):
    ...
    if 0 <= int(hypno_start_hour) < 5:
        ...
        if 0 <= int(edf_start_hour) < 5:
            ...
            new_edf_start_sec = (24*3600-edf_start_sec) + (hypno_start_sec-12*3600-0*3600-30)
...
def for_pe(path_subjects_edf, subject_edf, meas_time_df, path_save):
